                  ...
                  children: [
                    ...
                    Row(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () {
                              print('Comment button tapped for post ID: ${widget.post.id}');
                              print('Post title: ${widget.post.title}');
                              print('Comment count: ${widget.post.comments}');
                              
                              try {
                                print('Initializing CommentProvider and navigating to CommentScreen...');
                                
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) {
                                      print('Building CommentScreen with postId: ${widget.post.id}');
                                      
                                      return ChangeNotifierProvider(
                                        create: (_) {
                                          print('Creating new CommentProvider instance');
                                          final provider = CommentProvider();
                                          
                                          // Initialize and load comments
                                          Future.microtask(() {
                                            print('Loading comments from API for postId: ${widget.post.id}');
                                            provider.loadComments(widget.post.id, sortBy: 'recent').then((_) {
                                              print('Comments loaded successfully. Count: ${provider.comments.length}');
                                            }).catchError((error) {
                                ...
                                print('Error during comment navigation: $e');
